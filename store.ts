...
const initialVehicles: Vehicle[] = [
  { id: 'v1', brand: 'Toyota', model: 'Camry', plateNumber: 'ABC-1234', category: VehicleCategory.SEDAN, status: VehicleStatus.AVAILABLE, dailyRate: 50, maintenanceNotes: '', image: 'https://images.unsplash.com/photo-1621007947382-bb3c3994e3fb?q=80&w=400&h=300&auto=format&fit=crop', currentMileage: 12500, color: 'Silver', colorHex: '#C0C0C0', engineSize: '2.5L', fuelType: 'Hybrid', transmission: 'Automatic', doorCount: 4, lastServiceDate: '2024-10-01', nextServiceDate: getFutureDate(5), nextServiceType: 'Oil Change', maintenanceHistory: [] },
  { id: 'v2', brand: 'Honda', model: 'CR-V', plateNumber: 'XYZ-5678', category: VehicleCategory.SUV, status: VehicleStatus.AVAILABLE, dailyRate: 75, maintenanceNotes: '', image: 'https://images.unsplash.com/photo-1594502184342-2e12f877aa73?q=80&w=400&h=300&auto=format&fit=crop', currentMileage: 45000, color: 'White', colorHex: '#FFFFFF', engineSize: '1.5T', fuelType: 'Petrol', transmission: 'Automatic', doorCount: 5, lastServiceDate: '2024-08-15', nextServiceDate: getFutureDate(30), nextServiceType: 'Brake Inspection', maintenanceHistory: [] },
  { id: 'v3', brand: 'BMW', model: '4 Series', plateNumber: 'LUX-99', category: VehicleCategory.LUXURY, status: VehicleStatus.AVAILABLE, dailyRate: 180, maintenanceNotes: '', image: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?q=80&w=400&h=300&auto=format&fit=crop', currentMileage: 5000, color: 'Black', colorHex: '#000000', engineSize: '3.0L', fuelType: 'Petrol', transmission: 'Automatic', doorCount: 2, lastServiceDate: '2024-11-20', nextServiceDate: getFutureDate(120), nextServiceType: 'Full Service', maintenanceHistory: [] },
  { id: 'v4', brand: 'Tesla', model: 'Model 3', plateNumber: 'EV-442', category: VehicleCategory.LUXURY, status: VehicleStatus.AVAILABLE, dailyRate: 120, maintenanceNotes: '', image: 'https://images.unsplash.com/photo-1560958089-b8a1929cea89?q=80&w=400&h=300&auto=format&fit=crop', currentMileage: 2100, color: 'Red', colorHex: '#FF0000', engineSize: 'N/A', fuelType: 'Electric', transmission: 'Automatic', doorCount: 4, lastServiceDate: '2025-01-05', nextServiceDate: getFutureDate(180), nextServiceType: 'Tire Rotation', maintenanceHistory: [] },
  { id: 'v5', brand: 'Ford', model: 'F-150', plateNumber: 'TRK-001', category: VehicleCategory.PICKUP, status: VehicleStatus.AVAILABLE, dailyRate: 90, maintenanceNotes: 'Check transmission', image: 'https://images.unsplash.com/photo-1583121274602-3e2820c69888?q=80&w=400&h=300&auto=format&fit=crop', currentMileage: 18500, color: 'Blue', colorHex: '#0000FF', engineSize: '3.5L V6', fuelType: 'Petrol', transmission: 'Automatic', doorCount: 4, lastServiceDate: '2024-05-10', nextServiceDate: getFutureDate(-2), nextServiceType: 'Brake Inspection', maintenanceHistory: [] },
];
